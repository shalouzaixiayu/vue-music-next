...
// 注册推荐列表接口路由
router.get('/api/getRecommend', (req, res) => {
  // 第三方服务接口 url
...
// 注册歌手列表接口路由
router.get('/api/getSingerList', (req, res) => {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
  const HOT_NAME = '热'
...
// 注册歌手详情接口路由
router.get('/api/getSingerDetail', (req, res) => {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
...
router.get('/api/getSongsUrl', (req, res) => {
...
// 注册歌词接口
router.get('/api/getLyric', (req, res) => {
...
// 注册排行榜接口
router.get('/api/getTopList', (req, res) => {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
...
// 注册排行榜详情接口
router.get('/api/getTopDetail', (req, res) => {
  const url = 'https://u.y.qq.com/cgi-bin/musics.fcg'
  const {
    id,
    period
...
// 注册热门搜索接口
router.get('/api/getHotKeys', (req, res) => {
